    ...
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="{{ route('dashboard.index') }}">
                ...
                <span class="ms-1 font-weight-bold fs-4">I T A T S</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto h-100 " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                @can('admin')
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if ($currentRouteName == 'master.ruangan.index') active @endif"
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if ($currentRouteName == 'master.akademik.index') active @endif"
                            href="{{ route('master.akademik.index') }}">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if ($currentRouteName == 'master.jabatan.index') active @endif"
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if ($currentRouteName == 'master.unit-kemahasiswaan.index') active @endif"
                            ...
                            <span class="nav-link-text ms-1">Unit Kemahasiswaan</span>
                        </a>
                    </li>
                    <li class="nav-item">
                ...
                @endcan
                <li class="nav-item mt-3">
                    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Proposal</h6>
                </li>
                @if (Gate::any(['admin', 'unit-kemahasiswaan']))
                    <li class="nav-item">
                        <a class="nav-link @if (Str::startsWith($currentRouteName, 'proposal.')) active @endif "
                            ...
                            <span class="nav-link-text ms-1">Data Proposal</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @if (Str::startsWith($currentRouteName, 'laporan-kegiatan.')) active @endif "
                ...
                @if (Gate::any(['admin', 'verifikator']))
                    <li class="nav-item">
                        <a class="nav-link  @if (Str::startsWith($currentRouteName, 'approval-proposal.')) active @endif "
                            ...
                            <span class="nav-link-text ms-1">Approval Proposal</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  @if (Str::startsWith($currentRouteName, 'approval-laporan-kegiatan.')) active @endif "
                            href="{{ route('approval-laporan-kegiatan.index') }}">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <span class="nav-link-text ms-1">Approval Laporan Kegiatan</span>
                        </a>
                    </li>
                @endcan
                <li class="nav-item">
                    <a class="nav-link @if ($currentRouteName == 'tracking.index') active @endif"
                        ...
                        <span class="nav-link-text ms-1">Tracking Proposal</span>
                    </a>
                </li>
                <li class="nav-item mt-3">
